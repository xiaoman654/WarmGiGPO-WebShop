...
export MODEL_DIR=${MODEL_DIR:-/root/autodl-fs/WarmGiGPO-WebShop/outputs/sft/qwen25_1p5b_webshop_lora_verl_500/merged_model}
...
export EXPERIMENT_NAME=${EXPERIMENT_NAME:-qwen15b_sft500_gigpo_128_64}
