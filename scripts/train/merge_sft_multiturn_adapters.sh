...
python scripts/train/merge_lora_adapter.py \
  ...
  --adapter outputs/sft/qwen25_1p5b_webshop_lora_verl_multiturn_500/final_adapter \
  --output-dir outputs/sft/qwen25_1p5b_webshop_lora_verl_multiturn_500/merged_model
