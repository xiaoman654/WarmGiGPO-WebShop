...
python scripts/train/sft_lora.py \
  ...
  --train-file data/processed/sft_step_level_verl_deepseek_think_500/train.jsonl \
  --valid-file data/processed/sft_step_level_verl_deepseek_think_500/valid.jsonl \
  --output-dir outputs/sft/qwen25_1p5b_webshop_lora_verl_deepseek_think_500 \
