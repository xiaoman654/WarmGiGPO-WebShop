...
REQUEST_FILE=${REQUEST_FILE:-data/processed/deepseek_target_think_requests/webshop_multiturn_500_requests.jsonl}
OUTPUT_FILE=${OUTPUT_FILE:-data/processed/deepseek_target_think_requests/webshop_multiturn_500_responses.jsonl}
...
DEEPSEEK_USER_ID=${DEEPSEEK_USER_ID:-webshop-sft-target-think}
...
FAILURE_FILE=${FAILURE_FILE:-data/processed/deepseek_target_think_requests/webshop_multiturn_500_failures.jsonl}
INVALID_FILE=${INVALID_FILE:-data/processed/deepseek_target_think_requests/webshop_multiturn_500_invalid.jsonl}
