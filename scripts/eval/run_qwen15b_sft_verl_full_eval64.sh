...
TRAIN_FILE=${TRAIN_FILE:-/root/data/verl-agent/text_128_64/train.parquet}
VAL_FILE=${VAL_FILE:-/root/data/verl-agent/text_128_64/test.parquet}
EXPERIMENT_NAME=${EXPERIMENT_NAME:-qwen15b_sft_verl_full_eval64}
